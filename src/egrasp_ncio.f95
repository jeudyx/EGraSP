...
contains
  ...
  subroutine writerec(NP,X,Y,Z,U,V,W,mass,rho,dist)
    ...
    double precision , intent(in) , dimension(NP) :: X
    double precision , intent(in) , dimension(NP) :: Y
    double precision , intent(in) , dimension(NP) :: Z
    double precision , intent(in) , dimension(NP) :: U
    double precision , intent(in) , dimension(NP) :: V
    double precision , intent(in) , dimension(NP) :: W
    double precision , intent(in) , dimension(NP) :: mass
    double precision , intent(in) , dimension(NP) :: rho
    double precision , intent(in) , dimension(NP) :: dist
  ...
  subroutine open_ncio(NP,filename,X,Y,Z,U,V,W,mass,rho,dist)
    ...
    integer , intent(in) :: NP
    character (len=filelen) , intent(in) :: filename
    double precision , intent(out) , dimension(NP) :: X
    double precision , intent(out) , dimension(NP) :: Y
    double precision , intent(out) , dimension(NP) :: Z
    double precision , intent(out) , dimension(NP) :: U
    double precision , intent(out) , dimension(NP) :: V
    double precision , intent(out) , dimension(NP) :: W
    double precision , intent(out) , dimension(NP) :: mass
    double precision , intent(out) , dimension(NP) :: rho
    double precision , intent(out) , dimension(NP) :: dist
    integer , dimension(2) :: istart , icount
